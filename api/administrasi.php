                ...
                while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="hapus_administrasi.php?id=<?php echo $d['id_bayar']; ?>"class="btn-delete-small" onclick="return confirm('Apakah Anda yakin ingin menghapus data pembayaran ini?')">
